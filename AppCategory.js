...
import CategoryList from './components/ItemList';
            ...
            <LinearGradient
                ...
                <View style={styles.card}>
                    ...
                    <ScrollView contentContainerStyle={styles.listContainer}>
                        {Object.values(todos).map(todo => <CategoryList key={todo.id} {...todo} deleteTodo={this.deleteTodo} updateTodo={this.updateTodo} inCompleteTodo={this.inCompleteTodo} completeTodo={this.completeTodo} />)}
                    </ScrollView>
                </View>
            </LinearGradient>
        );
